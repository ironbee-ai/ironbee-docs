...
<CardGroup cols={2}>
    ...
    <Card title="IronBee Projects — Card View">
        <img src="/images/console/project/project-card-dark.png" alt="IronBee Projects — Card View" style={{borderRadius:'8px',width:'100%'}}/>
    </Card>
</CardGroup>
