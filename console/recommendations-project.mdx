...
<img src="/images/console/recommendation/recommendation-project-dark.png" alt="IronBee Console — Project Recommendations" style={{borderRadius:'8px',width:'100%'}} />
...
<img src="/images/console/recommendation/recommendation-detail-project-dark.png" alt="IronBee Console — Project Recommendations Detail" style={{borderRadius:'12px',width:'100%'}} />
