...
description: Recommendations across all projects on the account.
---
...
<img src="/images/console/recommendation/recommendation-account-dark.png" alt="IronBee Console — Account Recommendations" style={{borderRadius:'8px',width:'100%'}} />
...
<img src="/images/console/recommendation/recommendation-detail-account-dark.png" alt="IronBee Console — Account Recommendations Detail" style={{borderRadius:'12px',width:'100%'}} />
