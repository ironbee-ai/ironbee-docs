...
- **Node**, **Backend**, and **Android** opt-in; enable any you want gated.

<img src="/images/cli/platform-selection_browser.png" alt="Multi-select titled 'Which platforms should require verification?' with browser checked and node, backend, and android unchecked" style={{borderRadius:'8px',width:'100%'}} />
