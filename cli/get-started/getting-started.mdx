...
IronBee detects your AI client (Claude Code or Cursor) and sets it up automatically. If it can't detect one, it asks which client you use.
...
<CardGroup cols={2}>
  <Card title="How verification works" icon="shield-check" href="/cli/concepts/how-verification-works">
