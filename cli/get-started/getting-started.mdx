...
<img src="/images/cli/platform-selection_analyze.png" alt="Platform multi-select with the 's suggest (claude)' key highlighted and 'Analysing project with claude…' shown while IronBee recommends platforms" style={{borderRadius:'8px',width:'100%'}} />
