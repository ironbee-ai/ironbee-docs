...
| **Android** | Opt-in | Android app changes drives a real device or emulator over ADB launches the app, taps and swipes, takes screenshots and UI snapshots, and reads Logcat | `android-devtools` (`adt_*`) |
