...
<img src="/images/cli/verification-mode-selection_monitor-only.png" alt="Verification-mode picker with the cursor on monitor only, described as no enforcement, only track sessions / activity / tools to the collector" style={{borderRadius:'8px',width:'100%'}} />
