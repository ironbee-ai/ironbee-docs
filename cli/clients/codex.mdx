...
The same mention syntax applies to the other commands — `$ironbee-{manage,search,sync}-scenario` for [saved scenarios](/cli/guides/scenarios) and, when an [issue tracker is connected](/cli/guides/issue-tracking), `$ironbee-issue-track`.
