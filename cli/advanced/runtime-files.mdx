...
| `scenarios/<prefix>/` | Saved [verification scenarios](/cli/guides/scenarios) — reusable, parametric test scripts authored via `/ironbee-manage-scenario`, one folder per cycle (`bdt`, `ndt`, `bedt`, `adt`, `tdt`) | ✅ Yes |
