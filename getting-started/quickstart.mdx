...
<Steps>
  ...
  <Step title="Set up your project">
    `ironbee install` — auto-detects your AI client (Claude Code, Cursor, or Codex) and wires up hooks, MCP servers, and the verification skill.
  </Step>
...
Open Claude Code, Cursor, or Codex and give the agent a task. When it finishes editing code, IronBee intercepts the completion and requires verification:
