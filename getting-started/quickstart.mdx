...
<Steps>
  ...
  <Step title="Start your app and let the agent work">
    Run your dev server, give the agent a task, and IronBee requires the agent to verify its changes before the task can complete.
  </Step>
  <Step title="View results in the Console">
    Every session — tool calls, screenshots, verdicts, timing breakdowns — appears in the Console in real time.
  </Step>
</Steps>
...
## Step 5 — Start your app and let the agent work

Start your dev server, then open Claude Code or Cursor and give the agent a task:
