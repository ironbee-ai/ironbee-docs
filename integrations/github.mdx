...
It pairs with the [Vercel integration](/integrations/vercel), and it is also what binds an [`ironbee verify`](/cli/guides/verification-jobs) run to your repository.
